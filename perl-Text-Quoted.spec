...
Version  : 2.09
Release  : 1
URL      : https://cpan.metacpan.org/authors/id/A/AL/ALEXMV/Text-Quoted-2.09.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/A/AL/ALEXMV/Text-Quoted-2.09.tar.gz
...
tar -xf %{SOURCE1}
cd ..
%setup -q -n Text-Quoted-2.09
mkdir -p %{_topdir}/BUILD/Text-Quoted-2.09/deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Text-Quoted-2.09/deblicense/
