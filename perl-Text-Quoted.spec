...
cd ..
%setup -q -T -D -n Text-Quoted-2.10 -b 1
mkdir -p deblicense/
...
cp deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Text-Quoted/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/Text/Quoted.pm
...
/usr/share/package-licenses/perl-Text-Quoted/deblicense_copyright
